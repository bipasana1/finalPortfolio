...
<head>
    <meta charset="UTF-8">
    <title>Bipasana Poudel's Resume</title>
...
<body>
    <div class="container">
        <header class="d-flex flex-wrap justify-content-between align-items-center py-3 mb-0 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="./resume.php" class="nav-link active" aria-current="page">Resume</a></li>
    ...
    <div class="resume-section">
        <img src="./images/bpoudelResume.png" alt="Resume Image">

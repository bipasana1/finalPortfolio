...
<body>
    ...
    <div class="introduction">
        ...
        <div class="headshot-container">
            <img class="headshot" src="./assets/views/images/headshot.jpeg" alt="Bipasana's Headshot">
        </div>
        ...
        <div class="album py-5 card-container">
            <div class="container">
                <div class="row row-cols-2 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm fade-in">
                            <img class="easyEatz" src="./assets/views/images/easyEatz.png" alt="prefix to postfix calculator database">   
                            <div class="card-body">
                                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
